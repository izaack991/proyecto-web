          ...
          <div align="center" class="card border-secondary mb-3" style="max-width: 45rem;border:none;">
            <FONT COLOR="white">
              <div class="container text-center">
                <div class="row align-items-center">
                  <div class="col">
                    <div class="card-header bg-primary" align="center" style="width:35rem">Conservar una ventaja competitiva sobre otros</div>
            </FONT>
          </div>
          <div class="col">
          ...
          <div align="center" class="card border-secondary mb-3" style="max-width: 45rem;border:none;">
            <FONT COLOR="white">
              <div class="container text-center">
                <div class="row align-items-center">
                  <div class="col">
                    <div class="card-header bg-primary" align="center" style="width:35rem">Tomarse tiempo para pensar acerca de las necesidades de otras personas</div>
            </FONT>
          </div>
          <div class="col">
          ...
          <div align="center" class="card border-secondary mb-3" style="max-width: 45rem;border:none;">
            <FONT COLOR="white">
              <div class="container text-center">
                <div class="row align-items-center">
                  <div class="col">
                    <div class="card-header bg-primary" align="center" style="width:35rem">Mantener una cisión de la vida y optimista</div>
            </FONT>
          </div>
          <div class="col">
          ...
          <div align="center" class="card border-secondary mb-3" style="max-width: 45rem;border:none;">
            <FONT COLOR="white">
              <div class="container text-center">
                <div class="row align-items-center">
                  <div class="col">
                    <div class="card-header bg-primary" align="center" style="width:35rem">Mantenerse en buenos términos con tanta gente como sea posible
                    </div>
            </FONT>
          </div>
          <div class="col">
