...
<body>
  ...
  <form action="test_merril.php" method="POST">
    ...
    <div class="tab-content"> 
      <div class="tab-pane active" id="tab1" role="tabpane"><h6>INSTRUCCIONES :
      ...
      <div class="tab-pane" id="tab2" role="tabpane"><h6>INSTRUCCIONES:
      Ponga en la hoja de respuestas la letra correspondiente a la palabra que complete
      correctamente la oración</h6> 
        <div class='pregresp'>
      ...
      <div class="tab-pane" id="tab3" role="tabpane"><h6>INSTRUCCIONES:
      ...
      <div class="tab-pane" id="tab4" role="tabpane"><h6>INSTRUCCIONES :
      ...
      <div class="tab-pane" id="tab5" role="tabpane"><h6>INSTRUCCIONES:
      ...
      <div class="tab-pane" id="tab6" role="tabpane"><h6>INSTRUCCIONES :
      ...
      <div class="tab-pane" id="tab7" role="tabpane"><h6>INSTRUCCIONES: Seleccione el inciso correcto</h6> 
        <div class='pregresp'>
      ...
      <div class="tab-pane" id="tab8" role="tabpane"><h6>INSTRUCCIONES:
