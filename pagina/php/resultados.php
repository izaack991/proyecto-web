...
if(isset($_GET['puesto'])) {
    ...
    foreach($vacantesMismoPuesto as $vacante) {
        ...
        echo '<div class="d-flex justify-content-between align-items-center"><h4 class="card-title text-danger mb-0">'.$vacante['puesto'].'</h4>';
        ...
        if ($vacante['urgente'] !== null) {
            $urgenteTexto = $vacante['urgente'] === 0 ? 'Se Precisa Urgente' : $vacante['urgente'];
            if ($practicasUrgente !== '') {
