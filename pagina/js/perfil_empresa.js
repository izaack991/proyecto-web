                ...
                input_telefono = ""
                    ...
                    $.each(data.usuario, function (index, usuario) {
                        ...
                        input_telefono += `<h3 class='text-dark mb-3'>`+usuario.telefono+`</h3><div class="input-group"><span class="input-group-text rounded-0 text-white bg-primary font-weight-bold border-0" id="inputGroup-sizing-default">Teléfono</span>
                                      <input type="text" id="telefonoNom`+usuario.id_usuario+`" minlength="10" maxLength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" value="`+usuario.telefono+`" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"></div><br>`
