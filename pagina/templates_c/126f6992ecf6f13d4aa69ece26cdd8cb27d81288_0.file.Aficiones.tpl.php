...
function content_6348b412522bf7_20855862 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<form action="Aficiones.php" method="POST">
  <div style="margin-top: 2%; margin-left: 37%;">
    <div class="card border-primary mb-3" style="max-width: 20rem;">
      <div class="card-body">
      <h4 class="card-title">Aficiones</h4>
        <p class="card-text">
