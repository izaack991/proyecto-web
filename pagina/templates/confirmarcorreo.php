...
<body>
  ...
  <form id="formConfirmaCorreo" method="POST">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
          <h1 class="card-title text-center mb-4">Confirmar correo</h1>
              <div class="form-group">
                <label for="confirmMail">Correo</label>
                <input type="email" class="form-control" id="confirmMail" name="confirmMail" placeholder="Ingrese su email" required>
              </div>
