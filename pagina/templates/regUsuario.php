            ...
            <div id="DivUsuario">
                <form method="POST" id="miFormulario">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" name="txt_NOMBRE" class="texto" id="nombre"
                                placeholder="Escriba el Nombre" pattern="[A-Z a-z]+" required="true" value="<?php if ($nombre != "") {
                                    echo $nombre;
                                } ?>">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" name="txt_APELLIDOS" class="texto" id="apellido"
                                placeholder="Escriba sus Apellidos" pattern="[A-Z a-z]+" required="true" value="<?php if ($apellido == true) {
                                    echo $apellido;
                                } ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label>CURP: *</label><br>
                            <input class="form-control" type="text" id="curp" name="txt_CURP"
                                oninput="validarInput(this)" maxLength="18" minLength="18" pattern="[A-Z0-9]+"
                                style="width:100%;" placeholder="Ingrese su CURP">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input oninput="verificarContrasenas()" class="form-control" type="password"
                                name="txt_PASSWORD" class="texto" minlength="8" id="txt_PASSWORD" maxLength="30"
                                placeholder="Escriba la Contraseña" required="true"><br>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Confirme Contraseña: *</label><br>
                            <input oninput="verificarContrasenas()" class="form-control" type="password"
                                name="txt_PASSWORD2" class="texto" minlength="8" id="txt_PASSWORD2" maxLength="30"
                                placeholder="Confirme la Contraseña" required="true"><br>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" type="text"
                                onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="txt_TELEFONO"
                                class="texto" id="telefono" minlength="10" maxLength="10"
                                placeholder="Escriba su Número" required="true"><br>
                        </div>
                    </div>
                    ...
                    <center>
                        ...
                        <button type="button" class="btn btn-secondary"
                            onclick="location.href='login.php?xd=2'">Volver</button>
                    </center>
            </div>
        </div>
        </form>
