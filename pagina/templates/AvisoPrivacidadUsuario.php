...
<body style="background-color: #F8F6F3;">
  ...
  <div style="border-radius: 5px; padding: 20px; margin: 20px; background-color: white;">
    <h3 style="text-align: center; margin-bottom: 20px;">Aviso de privacidad integral</h3>
    <div style="text-align: justify;">
    <p>
      ARTICS SOLUCIONES EN TI SAS DE CV mejor conocido como ARTICS SOLUCIONES EN TI, con domicilio en RAUL CERVANTES AHUMADA #198 y portal de internet <a href="https://workele.com">https://workele.com</a>, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:
      </p>

      <p>
      ¿Para qué fines utilizaremos sus datos personales?
Los datos personales que recabamos de usted, los utilizaremos para las siguientes finalidades que son necesarias para el servicio que solicita: Prestación de cualquier servicio solicitado
      </p>

      <p>
      ¿Qué datos personales utilizaremos para estos fines?
Para llevar a cabo las finalidades descritas en el presente aviso de privacidad, utilizaremos los siguientes datos personales: Datos de identificación y contacto, Datos laborales, Datos académicos, Datos sobre pasatiempos
      </p>

      <p>
      ¿Qué datos no utilizaremos?
ARTICS Soluciones en TI no se encarga de postular usuarios ni de facilitar el contacto con las empresas. Los usuarios son responsables de postularse directamente a las vacantes ofrecidas por las empresas. Posteriormente, son las propias empresas las encargadas de establecer contacto con los usuarios seleccionados.
 </p>
...
Para el ejercicio de cualquiera de los derechos ARCO, debe enviar una petición vía correo electrónico a CONTACTO@WORKELE.COM y deberá contener:
